...
<head>
 ...
 <link rel="website icon" type="png" href="images/logo.png" style="border-radius: 50%;">
  ...
  <style>
    ...
    /* Ensure navbar has the highest z-index */
    .navbar {
      padding: 5px;
        z-index: 9999; /* Increased z-index */
    }

    /* Ensure the navbar-toggler (hamburger button) has the same high z-index */
    .navbar-toggler {
        z-index: 9999; /* Increased z-index */
    }

    /* Ensure navbar items are on top as well */
    .navbar-nav {
        z-index: 9999; /* Increased z-index */
    }
  </style>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 nav " style="cursor:pointer;">
          ...
          <li class="nav-item">
            <?php if (isset($_SESSION['name'])) {
              ?>
              <a class="nav-link " href="documentrequest.php"><i class="bi bi-file-earmark-text"></i> Document
                Request</a>
              <?php
            } else {
              ?>
              <a class="nav-link disabled" href="documentrequest.php"><i class="bi bi-file-earmark-text"></i> Document Request</a>
              <?php
            } ?>
          </li>
          <li class="nav-item">
